...
const entries: PortfolioEntry[] = [
    ...
    },
    {
        ...
        description: "This is a low budget website I built for a local nonprofit. The coolest thing about this website is the Stripe integration for donations. It is a static site deployed on Cloudflare Pages and uses a concise Cloudflare edge function to ensure that Stripe customers are recognized based on their email, rather than creating a new customer for each donation. Besides the domain name registration, it costs nothing to host. It also uses Google Calendar as a rudimenatary CMS, which was interesting to set up. We are planning to do another round of work expanding this website very soon."
    },
    {
        date: "2025 - Present",
        websiteUrl: "https://dtgbuilder.com",
        title: "DTG Builder",
        description: "This is the website you are currently on. I started building it when I was considering starting my own local business. I haven't had the time to finish it. It uses Cloudinary for image hosting and optimization and is deployed on Cloudflare Pages. I may take it in a completely different direction in the future. I am also considering a different domain name, but I haven't decided yet."
    },
    {
        date: "Jan 2024",
...
export default function Page() {
    return (
        ...
        >
            ...
            >
                <Typography>
                    Hi, my name is Dylan Green. I am a software engineer, web developer, and product builder. Here are some of my projects:
                </Typography>
                {entries.map((entry) => (
                    <PortfolioFeature
